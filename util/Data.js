export default {
  images: [
    {
      id: 1,
      img: require("../assets/HomeImages/fd.jpg"),
      title: "You want Authentic, here you go!",
      description: "Find it here, buy it now!",
    },
    {
      id: 2,
      img: require("../assets/HomeImages/nacklesh.jpg"),
      title: "You want Authentic, here you go!",
      description: "Find it here, buy it now!",
    },
    {
      id: 3,
      img: require("../assets/HomeImages/watch.jpg"),
      title: "You want Authentic, here you go!",
      description: "Find it here, buy it now!",
    },
  ],
  banners: [
    {
      id: 1,
      img: require("../assets/banner/banner-min.png"),
    },
    {
      id: 2,
      img: require("../assets/banner/banner-min2.png"),
    },
    {
      id: 3,
      img: require("../assets/banner/banner-min3.png"),
    },
    {
      id: 4,
      img: require("../assets/banner/banner-min4.png"),
    },
  ],
  categoriesData: [
    {
  ...
  productData: [
    ...
    },
    {
      ...
      price: 100,
      description:
        "A sleek leather handbag for women, perfect for any occasion.",
      image_uri:
